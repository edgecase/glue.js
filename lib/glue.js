...
*
* topic.each([callback]);
* topic.each('col', [callback];
* topic.each('v1.col', [callback]);
*
*/
Glue.prototype.each = function() {
};
...
*
* topic.map([callback]);
* topic.map('col', [callback];
* topic.map('v1.col', [callback]);
*
*/
Glue.prototype.map = function() {
};
...
* topic.filter('col', [callback];
* topic.filter('v1.col', [callback]);
*
*/
