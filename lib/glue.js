...
if("require" in this) var _ = require('underscore');
...
Glue.prototype.get = function(key, obj) {
  ...
  var returnVal;
  try{ returnVal = eval(key); }
  catch(e){ returnVal = undefined; }
  return returnVal; // I know eval is generally evil, but I think it's acceptable for this use case.
};
...
if("module" in this) module.exports = Glue;
