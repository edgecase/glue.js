var Glue=function(a){this.boundObject=a;this.listeners={};this.listenersCalcOrFunc={};this.anyKeyPath="*";this.keyPathIsCalculated=function(a){return!!a.match(/\(.+\)$/)};this.keyPathIsFunctional=function(a){return!!a.match(/.+\(\)$/)};this.keyPathIsFunctionalOrCalculated=function(a){return!!a.match(/\(?.+?\(?\)/)}};
