var Glue=function(a){this.target=a;this.updateCache();this.resetListeners()};Glue.version="0.5.0";Glue.prototype.resetListeners=function(){this.listeners={specific:{},generic:{}}};Glue.deepClone=function(a){var b;_.isArray(a)?b=_.map(a,function(a){return Glue.deepClone(a)}):"object"===typeof a?(b={},_.each(a,function(a,e){b[e]=Glue.deepClone(a)})):b=a;return b};Glue.prototype.updateCache=function(){this.cache=Glue.deepClone(this.target)};Glue.normalizeKey=function(a){return a.replace(/\s/g,"")};
...
Glue.prototype.notify=function(a,b,c){function e(a,b,c,f,e){if(!_.isEqual(c,f)){c={operation:a,oldValue:c,currentValue:f};if(!_.isUndefined(e))c.index=e;_.isEmpty(b.operations)?b.callback.call(b.context,c):_.include(b.operations,a)&&b.callback.call(b.context,c)}}var f=this;_.each(this.listeners.specific,function(b,c){var h=f.get(c),i=f.get(c,f.cache);_.each(b,function(b){e(a,b,i,h)})});(function(a,g,h,i){a=Glue.permutateKey(a);_.each(a,function(a){var b=a[0],c=a[2];_.each(f.listeners.generic[a[1]],
function(a){e(g,a,f.get(b,h),f.get(b,i),c)})});var l={};_.each(f.listeners.generic,function(a,c){b.match(RegExp("^"+b.replace("[","\\[").replace("]","\\]")))&&(l[c]=a)});_.each(l,function(a,b){var d=b.replace(/\[[^\[]*\]$/,""),j=f.get(d,h),k=f.get(d,i),d=j.length>k.length?j.length:k.length,d=c&&c.reverse?_.range(0,d).reverse():_.range(0,d);_.each(d,function(b){var c=j[b],d=k[b];_.each(a,function(a){e(g,a,c,d,b)})})})})(b,a,f.cache,f.target)};
...
Glue.prototype.remove=function(a){var b=a.match(/\[(\d+)\]$/);if(b){var c=b[1],b=a.lastIndexOf(b[0]);0===b?this.target.splice(c,1):this.get(a.substr(0,b)).splice(c,1)}else a=a.split("."),1<a.length?(c=a.pop(),delete this.get(a.join("."))[c]):delete this.target[a[0]],a=a.join(".");this.notify("remove",a);this.updateCache();return this};
...
Glue.prototype.sortBy=function(){var a=0,b=arguments,c=2>b.length?"":b[a++],e=b[a++];collectionWithIndex=_.map(this.get(c),function(a,b){return[a,b]});a=_.sortBy(collectionWithIndex,function(a){return e(a[0])});""===c?this.target=_.map(a,function(a){return a[0]}):(bs=this.baseKeyAndSuffix(c),bs[0][bs[1]]=_.map(a,function(a){return a[0]}));_.map(a,function(a){return a[1]});this.notify("filter",Glue.baseKey(c),{reverse:!0});this.updateCache()};
Glue.prototype.swap=function(a,b){var c=this,e=this.get(a),f=this.get(b),d=this.baseKeyAndSuffix(a),g=this.baseKeyAndSuffix(b);d[0][d[1]]=f;g[0][g[1]]=e;_.each(_.uniq(_.union(Glue.baseKey(a),Glue.baseKey(b))),function(a){c.notify("swap",a)})};
